...
public String preprocess_search_word(String s)
	{ String stemed="";
		
		if(s!="")
		{
		Vector<String> outStopWrods=removeStopwrords_qp(s);
...
public static Vector<String> removeStopwrords_qp(String inputpath)
	{
...
public BasicDBList search_query(String stemed)
{
	...
	BasicDBList my_urls_retreived = (BasicDBList)f.get("my_urls");
...
public static void main(String[] args) {
	...
	String search_word = p.preprocess_search_word("comput");
